...
var dev_msg = '<b>Dernières mises à jour:</b>' +
    "<br>&bull; Update édition d'inventaire (la qté commandée est maintenant en CAISSES!)" +
    "<br>&bull; Disposition des colonnes de l'inventaire";
